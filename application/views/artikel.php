	...
	<div class="container">	
		...
		<div class="blog">
			...
			<div class="conteudo">
				...
				<img  src="<?php echo base_url('upload/article/'.$article->image) ?>" class="img-fluid" alt="Responsive image">
				<h1> <?php echo $article->title ?> </h1>
				<hr>
				<p>
					<?php echo substr($article->text, 0, 400) ?>...
				</p>				
				<a href="<?php echo site_url('artikel/more/'.$article->id_article) ?>" class="continue-lendo">Selengkapnya →</a>
			</div>
		<?php endforeach; ?>
		</div>
